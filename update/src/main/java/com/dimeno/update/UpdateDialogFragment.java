...
import com.dimeno.update.service.DownloadService;
import com.dimeno.update.utils.AppUpdateUtils;
import com.dimeno.update.utils.ColorUtil;
import com.dimeno.update.utils.DrawableUtil;
import com.dimeno.update.view.NumberProgressBar;
...
//            AppUpdateUtils.installApp(getActivity(), AppUpdateUtils.getAppFile(mUpdateApp));
            AppUpdateUtils.install(getActivity(), AppUpdateUtils.getAppFile(mUpdateApp));
            //安装完自杀
            dismiss();
        } else {
            downloadApp();
