package com.dimeno.update.service;
...
import com.dimeno.update.interfac.HttpManager;
import com.dimeno.update.R;
...
//    }
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationChannel channel = new NotificationChannel("001", "正在连接服务器", NotificationManager.IMPORTANCE_LOW);
